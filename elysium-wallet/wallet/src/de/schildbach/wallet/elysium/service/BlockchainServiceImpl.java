...
package de.schildbach.wallet.elysium.service;
...
import com.google.elysium.discovery.*;
import com.google.elysium.store.BlockStore;
import com.google.elysium.store.BlockStoreException;
...
import de.schildbach.wallet.elysium.WalletBalanceWidgetProvider;
import de.schildbach.wallet.elysium.ui.WalletActivity;
import de.schildbach.wallet.elysium.util.ThrottelingWalletChangeListener;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
    ...
    private static final String TAG = "Elysium"+BlockchainServiceImpl.class.getSimpleName();
    ...
    private void notifyCoinsReceived(final Address from, final BigInteger amount)
    {
        ...
        final int precision = Integer.parseInt(prefs.getString(Constants.PREFS_KEY_ELSM_PRECISION, Integer.toString(Constants.ELSM_PRECISION)));
        ...
        private void check()
        {
            ...
            if (hasEverything && peerGroup == null)
            {
                ...
                try {
                    ...
                    Log.e("Elysium", "There's no method: " + e.getLocalizedMessage());
                    Log.e("Elysium", "Elysiumj issue.  We're going to ignore this for now and just try and return nicely.");
    ...
    public void notifyWidgets()
    {
        ...
        try {
            ...
            Log.e("Elysium", "App server appears dead - Runtime Exception when running getAppWidgetIds.  Returning..");
            return;
        }
