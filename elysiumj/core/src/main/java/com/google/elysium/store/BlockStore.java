...
import com.google.elysium.core.StoredBlock;
 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the Elysium serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.elysium.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.elysium.core.BlockChain#getBestChainHeight()} which will run in constant time and
