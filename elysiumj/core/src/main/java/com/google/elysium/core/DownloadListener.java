...
java.io.FileOutputStream fileOutput = new java.io.FileOutputStream(file, true);
java.io.OutputStreamWriter outputStreamWriter=new java.io.OutputStreamWriter(fileOutput);
outputStreamWriter.append("Downloadlistener onChainDownloadStarted " + blocksLeft+ System.getProperty("line.separator"));
