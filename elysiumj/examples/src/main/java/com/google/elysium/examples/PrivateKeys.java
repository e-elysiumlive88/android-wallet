...
public class PrivateKeys {
    public static void main(String[] args) throws Exception {
        ...
        try {
            // Decode the private key from Satoshis Base58 variant. If 51 characters long then it's from Elysiums
            ...
            // And take them!
            System.out.println("Claiming " + Utils.elysiumValueToFriendlyString(wallet.getBalance()) + " coins");
