...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_LITECOINJ = "about_credits_elysiumj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_LITECOINJ).setTitle(getString(R.string.about_credits_elysiumj_title, VersionMessage.LITECOINJ_VERSION));
