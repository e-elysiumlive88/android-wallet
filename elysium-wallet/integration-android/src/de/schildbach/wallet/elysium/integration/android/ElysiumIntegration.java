...
package de.schildbach.wallet.elysium.integration.android;
 ...
 */
public final class ElysiumIntegration
{
	private static final String INTENT_EXTRA_TRANSACTION_HASH = "transaction_hash";

	/**
	 * Request any amount of Elysium (probably a donation) from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request specific amount of Elysium from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request any amount of Elysium (probably a donation) from user, with feedback from the app. Result intent can be
	 ...
	 * 
	 * Warning: A success indication is no guarantee! To be on the safe side, you must drive your own Elysium
	...
	/**
	 * Request specific amount of Elysium from user, with feedback from the app. Result intent can be received by
	...
	/**
	 * Put transaction hash into result intent. Meant for usage by Elysium wallet applications.
	 * 
	 * @param result
	 *            result intent
	 * @param txHash
	...
	/**
	 * Get transaction hash from result intent. Meant for usage by applications initiating a Elysium payment.
	 * 
	 * You can use this hash to request the transaction from the Elysium network, in order to validate. For this, you
	 * need your own Elysium infrastructure though. There is no guarantee that the transaction has ever been broadcasted
	...
	{
		final StringBuilder uri = new StringBuilder("elysium:");
		if (address != null)
			uri.append(address);
		if (amount != null)
