...
package com.google.elysium.examples.toywallet;
...
import com.google.elysium.store.H2FullPrunedBlockStore;
...
public class ToyWallet {
            ...
            switch (col) {
                ...
                case 2:
                    try {
                        ...
                        return Utils.elysiumValueToFriendlyString(val);
    ...
    public ToyWallet(boolean testnet, boolean fullChain, String[] args) throws Exception {
        // Set up a Elysium connection + empty wallet. TODO: Simplify the setup for this use case.
        if (testnet) {
    ...
    private void setupWindow(JFrame window) {
        ...
        networkStats = new JLabel("Connecting to the Elysium network ...");
