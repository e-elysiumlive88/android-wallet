...
public final class SendCoinsActivity extends AbstractWalletActivity
{
	...
	private void handleIntent(final Intent intent)
	{
		...
		if ((Intent.ACTION_VIEW.equals(action) || NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) && intentUri != null && "elysium".equals(scheme))
		{
			try
			{
				final ElysiumURI elysiumUri = new ElysiumURI(null, intentUri.toString());
				address = elysiumUri.getAddress().toString();
				addressLabel = elysiumUri.getLabel();
				amount = elysiumUri.getAmount();
			}
