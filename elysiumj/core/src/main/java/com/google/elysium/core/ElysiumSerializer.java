...
/**
 * <p>Methods to serialize and de-serialize messages to the Elysium network format as defined in
 * <a href="https://en.elysium.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.elysiumSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class ElysiumSerializer {
    private static final Logger log = LoggerFactory.getLogger(ElysiumSerializer.class);
    ...
    /**
     * Constructs a ElysiumSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public ElysiumSerializer(NetworkParameters params) {
     ...
     */
    public ElysiumSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("ElysiumSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.elysiumSerialize();
    ...
    public Message deserialize(InputStream in) throws ProtocolException, IOException {
        // A Elysium protocol message has the following format.
        //
        ...
        ElysiumPacketHeader header = new ElysiumPacketHeader(in);
     ...
     */
    public ElysiumPacketHeader deserializeHeader(InputStream in) throws ProtocolException, IOException {
        return new ElysiumPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link ElysiumSerializer#deserializeHeader}.
     */
    public Message deserializePayload(ElysiumPacketHeader header, InputStream in) throws ProtocolException, IOException {
        int readCursor = 0;
    ...
    public static class ElysiumPacketHeader {
        public final byte[] header;
        public final String command;
        public final int size;
        public final byte[] checksum;

        public ElysiumPacketHeader(InputStream in) throws ProtocolException, IOException {
