...
import com.google.elysium.core.Block;
import com.google.elysium.core.FullPrunedBlockChain;
...
public class BlockImporter {
    public static void main(String[] args) throws Exception {
        ...
        if (System.getProperty("os.name").toLowerCase().indexOf("win") >= 0) {
            defaultDataDir = System.getenv("APPDATA") + "\\.elysium/";
        } else {
            defaultDataDir = System.getProperty("user.home") + "/.elysium/";
        }
