...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        // copied verbatim from https://en.elysium.it/wiki/Protocol_specification#Network_address
        ...
        String reserialized = Utils.bytesToHexString(pa.elysiumSerialize());
        assertEquals(reserialized,fromSpec );
    }

    @Test
    public void testElysiumSerialize() throws Exception {
        ...
        assertEquals("000000000000000000000000000000000000ffff7f000001208d",
                Utils.bytesToHexString(pa.elysiumSerialize()));
    }
}
