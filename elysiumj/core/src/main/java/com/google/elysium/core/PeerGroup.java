...
import com.google.elysium.core.Peer.PeerHandler;
import com.google.elysium.discovery.PeerDiscovery;
import com.google.elysium.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService {
    ...
    // pipeline with the elysium serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.elysium.it/wiki/BIP_0014">BIP 14</a>.
     *
     ...
     * peers. By using this with {@link com.google.elysium.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.elysium.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.elysium.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the Elysium
     ...
     * times are available via {@link com.google.elysium.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.elysium.core.Peer#ping()}.
     */
