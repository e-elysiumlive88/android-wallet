...
import com.google.elysium.core.ProtocolException;
import com.google.elysium.core.Sha256Hash;
import com.google.elysium.core.Transaction;
import com.google.elysium.core.VerificationException;
...
import de.schildbach.wallet.elysium.util.Base43;
...
public final class TransactionActivity extends AbstractWalletActivity
{
	...
	private void handleIntent(final Intent intent)
	{
		...
		else if (intentUri != null && "elsmtx".equals(scheme))
		{
			try
			{
	...
	private void updateView()
	{
		...
		if (nfcManager != null)
			NfcTools.publishMimeObject(nfcManager, this, Constants.MIMETYPE_TRANSACTION, tx.unsafeElysiumSerialize(), false);
	}
