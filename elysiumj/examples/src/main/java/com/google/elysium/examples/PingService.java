...
package com.google.elysium.examples;

import com.google.elysium.core.*;
import com.google.elysium.crypto.KeyCrypterException;
import com.google.elysium.discovery.DnsDiscovery;
import com.google.elysium.discovery.IrcDiscovery;
import com.google.elysium.store.BlockStore;
import com.google.elysium.store.SPVBlockStore;
 ...
 * <li>Start your elysium client in test mode <code>elysium -testnet</code>. This will create a new sub-directory called testnet and should not interfere with normal wallets or operations.</li>
 * <li>(Optional) Choose a fresh address</li>
 * <li>(Optional) Visit the Testnet faucet (https://testnet.freeelysiums.appspot.com/) to load your client with test coins</li>
 * <li>Run <code>PingService testnet</code></li>
 * <li>Wait for the block chain to download</li>
 * <li>Send some coins from your elysium client to the address provided in the PingService console</li>
 ...
 * .net/projects/elysium/files/Elysium/testnet-in-a-box/">testnet in a box</a> to do everything purely locally.</p>
 */
public class PingService {
    ...
    public PingService(String[] args) throws Exception {
        ...
        if (testNet) {
            peerGroup.addPeerDiscovery(new IrcDiscovery("#elysiumTEST3"));
        } else {
        ...
        wallet.addEventListener(new AbstractWalletEventListener() {
            ...
            public void onCoinsReceived(Wallet w, Transaction tx, BigInteger prevBalance, BigInteger newBalance) {
                ...
                System.out.println("Received pending tx for " + Utils.elysiumValueToFriendlyString(value) +
                        ": " + tx);
    ...
    private void bounceCoins(final Wallet wallet, Transaction tx) {
        // It's impossible to pick one specific identity that you receive coins from in Elysium as there
        ...
        try {
            ...
            System.out.println("Received " + Utils.elysiumValueToFriendlyString(value) + " from " + from.toString());
