...
package com.google.elysium.discovery;

import com.google.elysium.core.AddressFormatException;
import com.google.elysium.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#elysium" or "#elysiumTEST3" for the production and test networks
     *                respectively.
     */
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // elysiumj but not match the standard nick format, so full peers don't try and connect to us.
    ...
    static ArrayList<InetSocketAddress> parseUserList(String[] userNames) throws UnknownHostException {
        ...
        for (String user : userNames) {
            // All Elysium peers start their nicknames with a 'u' character.
            ...
            try {
                ...
                // so simply beginning with "u" does not imply this is a valid Elysium encoded address.
                //
