...
import com.google.elysium.core.*;
import com.google.elysium.core.TransactionConfidence.ConfidenceType;
import com.google.elysium.core.Wallet.BalanceType;
import com.google.elysium.core.Wallet.SendRequest;
import com.google.elysium.uri.ElysiumURI;
import com.google.elysium.uri.ElysiumURIParseException;

import com.google.zxing.integration.android.IntentIntegrator;
import com.google.zxing.integration.android.IntentIntegratorSupportV4;
import com.google.zxing.integration.android.IntentResult;
import de.schildbach.wallet.elysium.AddressBookProvider;
import de.schildbach.wallet.elysium.Constants;
import de.schildbach.wallet.elysium.WalletApplication;
import de.schildbach.wallet.elysium.integration.android.ElysiumIntegration;
import de.schildbach.wallet.elysium.service.BlockchainService;
import de.schildbach.wallet.elysium.service.BlockchainServiceImpl;
...
public final class SendCoinsFragment extends SherlockFragment implements AmountCalculatorFragment.Listener
{
	...
	private final CurrencyAmountView.Listener amountsListener = new CurrencyAmountView.Listener()
	{
		...
		{
			dismissPopup();
            Log.d("Elysium", "Amount: " + amountView.getAmount() + ", Fee: " + feeView.getAmount());
		...
		viewGo.setOnClickListener(new OnClickListener()
		{
			...
			private void feeDialog()
			{
				...
				dialog.setMessage(getString(R.string.send_coins_dialog_fee_message,
						Constants.CURRENCY_CODE_ELYSIUM + " " + WalletUtils.formatValue(Constants.DEFAULT_TX_FEE, Constants.ELSM_PRECISION)));
				if (allowLowFee)
				{
	...
	private void popupAvailable(final View anchor, final BigInteger available, final BigInteger pending)
	{
		...
		viewAvailable.setPrefix(Constants.CURRENCY_CODE_ELYSIUM);
		...
		viewPending.setText(getString(R.string.send_coins_fragment_pending, WalletUtils.formatValue(pending, Constants.ELSM_PRECISION)));
	...
	private void handleGo()
	{
		...
		backgroundHandler.post(new Runnable()
		{
			public void run()
			{
                ...
                Log.d("Elysium", "Transaction size is " + txSize);
                /* From official Elysium wallet.cpp
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        try {
                                            ...
                                            Log.i("ElysiumSendCoins", "VerificationException: " + e);
                                            return;
                                        }
                                        // Fees are agreeable
    ...
    class TransactionRunnable implements Runnable {
        ...
        public void run()
        {
            ...
            ElysiumIntegration.transactionHashToResult(result, sentTransaction.getHashAsString());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (scanResult != null) {
            ElysiumURI uri = WalletUtils.parseAddressString(scanResult.getContents());
            if(uri != null)
	...
	private void updateView()
	{
		...
		if (sentTransaction != null)
		{
			...
			sentTransactionListAdapter.setPrecision(Integer.parseInt(prefs.getString(Constants.PREFS_KEY_ELSM_PRECISION,
					Integer.toString(Constants.ELSM_PRECISION))));
