...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a Elysium node over the standard TCP/IP protocol.<p>
 *
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private ElysiumSerializer serializer = null;
    ...
    public TCPNetworkConnection(NetworkParameters params, VersionMessage ver) {
        ...
        this.serializer = new ElysiumSerializer(this.params);
    ...
    private void onVersionMessage(Message m) throws IOException, ProtocolException {
        ...
        // elysiumj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a Elysium message passing upstream in the channel.
        //
        ...
        /** Serialize outgoing Elysium messages passing downstream in the channel. */
    ...
    /** Returns the Netty Pipeline stage handling Elysium serialization for this connection. */
