...
public class TransactionsListFragment extends SherlockListFragment implements LoaderCallbacks<List<Transaction>>, OnSharedPreferenceChangeListener
{
				...
				false)
		{
			...
			public void onThrotteledWalletChanged()
			{
                ...
                } catch(RejectedExecutionException e)
                {
                    ...
                    Log.d("Elysium", "RejectedExecutionException on forceLoad()");
                }
			}
		};
	...
	{
		if (Constants.PREFS_KEY_ELSM_PRECISION.equals(key))
			updateView();
	}

	private void updateView()
	{
		adapter.setPrecision(Integer.parseInt(prefs.getString(Constants.PREFS_KEY_ELSM_PRECISION, Integer.toString(Constants.ELSM_PRECISION))));
