 ...
 * Currently this includes getaddr, ping, verack as well as the special elysiumj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void elysiumSerializeToStream(OutputStream stream) throws IOException {
    }
