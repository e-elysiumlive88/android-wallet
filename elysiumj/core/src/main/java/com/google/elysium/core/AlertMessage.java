 ...
 * The private keys are held by a small group of core Elysium developers, and alerts may be broadcast in the event of
...
public class AlertMessage extends Message {
    ...
    void parse() throws ProtocolException {
        ...
        version = readUint32();
        // Read the timestamps. Elysium uses seconds since the epoch.
