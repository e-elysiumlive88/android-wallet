...
import com.google.elysium.core.Transaction.SigHash;
...
import com.google.elysium.store.BlockStore;
import com.google.elysium.store.MemoryBlockStore;
import com.google.elysium.utils.BriefLogFormatter;
import com.google.common.collect.Lists;
import com.google.protobuf.ByteString;

import org.elysiumj.wallet.Protos;
import org.elysiumj.wallet.Protos.ScryptParameters;
...
import static com.google.elysium.core.TestUtils.*;
import static com.google.elysium.core.TestUtils.createFakeBlock;
import static com.google.elysium.core.TestUtils.createFakeTx;
import static com.google.elysium.core.Utils.elysiumValueToFriendlyString;
import static com.google.elysium.core.Utils.toNanoCoins;
...
public class WalletTest {
    ...
    private void basicSpendingCommon(Wallet wallet, Address toAddress, boolean testEncryption) throws Exception {
        ...
        // will attach a small fee. Because the Elysium protocol makes it
    ...
    public void blockChainCatchup() throws Exception {
        ...
        assertEquals(elysiumValueToFriendlyString(wallet.getBalance()), "0.90");
        assertEquals(null, txn[0]);
        assertEquals(2, confTxns.size());
        assertEquals(txn[1].getHash(), send1.getHash());
        assertEquals(elysiumValueToFriendlyString(bigints[2]), "1.00");
        assertEquals(elysiumValueToFriendlyString(bigints[3]), "0.90");
        ...
        assertEquals(elysiumValueToFriendlyString(wallet.getBalance()), "0.80");
    ...
    public void balances() throws Exception {
        ...
        Transaction send1 = wallet.createSend(new ECKey().toAddress(params), toNanoCoins(0, 10));
        // Reserialize.
        Transaction send2 = new Transaction(params, send1.elysiumSerialize());
    ...
    public void isConsistent_duplicates() throws Exception {
        ...
        Transaction txClone = new Transaction(params, tx.elysiumSerialize());
        try {
    ...
    public void doubleSpendUnspendsOtherInputs() throws Exception {
        ...
        send2 = new Transaction(params, send2.elysiumSerialize());
    ...
    public void pending1() throws Exception {
        ...
        final Transaction t1Copy = new Transaction(params, t1.elysiumSerialize());
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("elysiumj-unit-test", null);
