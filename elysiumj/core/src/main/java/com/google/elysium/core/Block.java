...
import static com.google.elysium.core.Utils.doubleDigest;
import static com.google.elysium.core.Utils.scryptDigest;
import static com.google.elysium.core.Utils.doubleDigestTwoBuffers;
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so Elysium can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the Elysium wire format. */
    ...
    /**
     * Contruct a block object from the Elysium wire format.
    ...
    /**
     * <p>A utility method that calculates how much new Elysium would be created by the block at the given height.
     * The inflation of Elysium is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link com.google.elysium.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    @Override
    protected void elysiumSerializeToStream(OutputStream stream) throws IOException {
        writeHeader(stream);
    ...
    /** Returns the version of the block data structure as defined by the Elysium protocol. */
     ...
     * {@link com.google.elysium.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the Elysium "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, BigInteger value) {
        ...
        coinbase.length = coinbase.elysiumSerialize().length;
