...
import de.schildbach.wallet.elysium.DetermineFirstSeenThread;
...
public final class WalletAddressesFragment extends SherlockListFragment
{
	...
	public void onListItemClick(final ListView l, final View v, final int position, final long id)
	{
		activity.startActionMode(new ActionMode.Callback()
		{
			...
			{
				final String uri = ElysiumURI.convertToElysiumURI(address, null, null, null);
			...
			private void handleCopyToClipboard(final Address address)
			{
                ...
                if(sdk < android.os.Build.VERSION_CODES.HONEYCOMB) {
                    ...
                    android.content.ClipData clip = android.content.ClipData.newPlainText("ELSM Address", address.toString());
