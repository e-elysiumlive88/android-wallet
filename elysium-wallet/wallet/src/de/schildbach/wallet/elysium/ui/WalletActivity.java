...
import de.schildbach.wallet.elysium.util.EncryptionUtils;
import de.schildbach.wallet.elysium.util.IOUtils;
import de.schildbach.wallet.elysium.util.Iso8601Format;
                ...
                if(args.getInt("next") == DIALOG_NEXT_GET_NEW_APP) {
                    ...
                    builder
                        ...
                        .setNeutralButton(R.string.button_install_new_app, new OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                intent.setData(Uri.parse("market://details?id=elysium"));
                                startActivity(intent);
                            }
                        });
                    ...
                    builder
                        ...
                        .setNeutralButton(R.string.button_import_into_new_app, new OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                                // Throw import intent to elysium app
                                Intent sendIntent = new Intent();
                                sendIntent.setAction(Intent.ACTION_VIEW);
                                Uri uri = Uri.fromFile(file);
                                Log.i(TAG, "URI to file: " + uri);
                                sendIntent.setDataAndType(uri, "x-elysium/private-keys");
