...
package com.google.elysium.store;
 ...
 * <a href="http://e-elysium.com/apis/protocolbuffers/docs/overview.html">protocol buffer</a>. Protocol buffers are
 * a data interchange format developed by Google with an efficient binary representation, a type safe specification
 * language and compilers that generate code to work with those data structures for many languages. Protocol buffers
 * can have their format evolved over time: conceptually they represent data using (tag, length, value) tuples. The
 * format is defined by the <tt>elysium.proto</tt> file in the elysiumj source distribution.<p>
 *
...
public class WalletProtobufSerializer {
    ...
    protected WalletTransaction connectTransactionOutputs(org.elysiumj.wallet.Protos.Transaction txProto) {
