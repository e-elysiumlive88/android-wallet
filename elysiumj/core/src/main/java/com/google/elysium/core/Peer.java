...
/**
 * A Peer handles the high level communication with a Elysium node.
 *
 * <p>{@link Peer#getHandler()} is part of a Netty Pipeline with a Elysium serializer downstream of it.
 */
public class Peer {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that elysium-qt is single threaded and processes messages in order.
    ...
    class PeerHandler extends SimpleChannelHandler {
        ...
        /** Handle incoming Elysium messages */
        @Override
  ...
  private void processMessage(MessageEvent e, Message m) throws IOException, VerificationException, ProtocolException {
    ...
    /** Returns the Netty Pipeline stage handling the high level Elysium protocol. */
    ...
    private void blockChainDownload(Sha256Hash toHash) throws IOException {
        ...
        try {
            ...
            //
            //   https://en.elysium.it/wiki/Protocol_specification#getblocks
            //
     ...
     * Once the pong is received the value returned by {@link com.google.elysium.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.elysium.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.elysium.core.Peer#ping()} has never
