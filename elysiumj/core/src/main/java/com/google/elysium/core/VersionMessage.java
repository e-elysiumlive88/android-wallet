...
public class VersionMessage extends Message {
    ...
    public static final String ELYSIUMJ_VERSION = "0.8-SNAPSHOT";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/ElysiumJ:" + ELYSIUMJ_VERSION + "/";
    ...
    @Override
    public void elysiumSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.elysiumSerialize(buf);
            // Their address.
            theirAddr.elysiumSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for ElysiumJ
     * users might look like "/ElysiumJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/ElysiumJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://en.elysium.it/wiki/BIP_0014">BIP 14</a> for more information.
     *
