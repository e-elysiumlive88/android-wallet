...
import static com.google.elysium.core.Utils.COIN;
...
/**
 * <p>NetworkParameters contains the data needed for working with an instantiation of a Elysium chain.</p>
 *
 * Currently there are only two, the production chain and the test chain. But in future as Elysium
...
public class NetworkParameters implements Serializable {
	...
	public static final byte[] SATOSHI_KEY = Hex.decode("a3821465ef3c4be973f9b42b7fb39a861cc251aea0fc775bc08c6386b01762702f92c5acf09588545490de34691c198037bae3ac63a81679b5773e46b451e65152");


    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_PRODNET = "5.135.26.151";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.elysium.test";
    /** Unit test network. */
    static final String ID_UNITTESTNET = "com.google.elysium.unittest";
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all Elysium implemenetations. For a
    ...
    /** How many blocks pass between difficulty adjustment periods. Elysium standardises this to be 2015. */
    public /*final*/ int interval;
    /**
     * How much time in seconds is supposed to pass between "interval" blocks. If the actual elapsed time is
     * significantly different from this value, the network difficulty formula will produce a different value. Both
     * test and production Elysium networks use 2 weeks (1209600 seconds).
     */
    ...
    private NetworkParameters(int type) {
        ...
        if (type == 0 || type == 100) {
            ...
            acceptableAddressCodes = new int[] { 122 };
            dumpedPrivateKeyHeader = 128;
            addressHeader = 122;
            if(type == 100) port = 10457;
            else port = 9388;
            packetMagic = 0xfbc0b6db;
            genesisBlock.setDifficultyTarget(493092763L);
            genesisBlock.setTime(1488669347L);
            genesisBlock.setNonce(1796819953L);
            genesisBlock.setMerkleRoot(new Sha256Hash("3a2bb50cfa5ca6357a9fa46271c917edf80b6f6f2b6846196add6751aaf03378"));
            id = ID_PRODNET;
            ...
            checkState(genesisHash.equals("d24b59252d11d8d27c52d3365e42341e341a59b9ae33847dbff2bd87510b5341"),
                    genesisHash);
            ...
            //checkpoints.put(0, new Sha256Hash("0000000b5b74041d0a36c14ae8f4811f50e158d6e169bb62ca62d8be41d47cd8"));
			//checkpoints.put(0, new Sha256Hash("d24b59252d11d8d27c52d3365e42341e341a59b9ae33847dbff2bd87510b5341"));
    ...
    private static Block createGenesis(NetworkParameters n) { 
        ...
        try {
			...
			//ellysium
			String txVinGenesis = "CTxIn(COutPoint(0000000000, 4294967295), coinbase 04ffff001d01041b43726561746564204279205361746f736869204e616b616d6f746f)";

			byte[] bytes = txVinGenesis.getBytes();


			//byte[] bytes = Hex.decode("04b217bb4e022309");
			...
			Script.writeBytes(scriptPubKeyBytes, Hex.decode
                    ("a3821465ef3c4be973f9b42b7fb39a861cc251aea0fc775bc08c6386b01762702f92c5acf09588545490de34691c198037bae3ac63a81679b5773e46b451e65152"));
            
			scriptPubKeyBytes.write(Script.OP_CHECKSIG);
            
			t.addOutput(new TransactionOutput(n, t, Utils.toNanoCoins(550, 0), scriptPubKeyBytes.toByteArray()));
    ...
    public static final int TARGET_TIMESPAN = 302400;//(int)(3.5 * 24 * 60 * 60);  // 3.5 days per difficulty cycle, on average.
    public static final int TARGET_SPACING = 120;//(int)(2.5 * 60);  // 2.5 minutes per block.
     ...
     */
    public static final BigInteger MAX_MONEY = new BigInteger("704000000", 10).multiply(COIN);
    ...
    /** The primary Elysium chain created by Satoshi. */
    ...
    /** The primary Elysium chain created by Hank. */
